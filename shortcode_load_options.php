...
Class ShortcodeLoad_Options extends ShortcodeLoad {
    ...
    **/
    ...
    function shortcode_load_help_documentation_callback() {
        ...
        $html .= '<li>id <strong>* <small>required</small></strong>';
        ...
        $html .= '<li>raw_data';
        $html .= '<ul id="shortcode_load_parameters_raw_data">';
        $html .= '<li>This parameter is useful when you need to output extra data from your page, such as javascript variables, CDATA, dynamic content generated by another plugin or data output from another shortcode. Depending on how other plugins output data from their shortcode it might not work as expected. The raw_data content will be dumped before the file is loaded.';
        $html .= '<li><span class="help_example"><strong>Example:</strong> [shortcode_load id="2" raw_data="<script>var myVariable=\'14\',mySecondVariable=\'true\',myThirdVariable=\'somevalue123\'</script>"]</span></li>';
