        ...
        <div class="wrap">
            ...
            <form action='options.php' method='post'>
                ...
                if($active_tab == 'tab_overview') {
                    $this->shortcode_load_load_file('datatables-style', 'lib/datatables/media/css/jquery.dataTables.min.css', false, false);
                    $this->shortcode_load_load_file('datatables-style.bootstrap', 'admin-style/css/dataTables.bootstrap.css', false, false);
