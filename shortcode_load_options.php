...
Class ShortcodeLoad_Options extends ShortcodeLoad {
    ...
    **/
    ...
    function shortcode_load_help_documentation_callback() {
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><p class="help_example_text"><strong>Example:</strong></p><span class="help_example"><code>[shortcode_load id="2"]</code></span></li>';
        ...
        $html .= '</ul>';
        $html .= '</li>';        
        $html .= '<li><p class="help_example_text"><strong>Example:</strong></p><span class="help_example"><code>[shortcode_load id="2" revision_override="14"]</code></span>';
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><p class="help_example_text"><strong>Example:</strong></p><span class="help_example"><code>[shortcode_load id="2" minify_override="true"]</code></span>';
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><p class="help_example_text"><strong>Example:</strong></p><span class="help_example"><code>[shortcode_load id="2" jquery_override="true"]</code></span>';
        $html .= '</ul>'; // ./shortcode_load_parameters_jquery_override
        $html .= '</li>';

        $html .= '<li><h4>data</h4>';
        $html .= '<ul id="shortcode_load_parameters_data">';
        $html .= '<li>This parameter is useful when you need to output extra data from your page, such as javascript variables, dynamic content generated by another plugin or data output from another shortcode. Depending on how other plugins output data from their shortcode it might not work as expected. The content will be dumped to the page before the file is loaded.</li>';
        $html .= '<li><p class="help_example_text"><strong>Example:</strong></p><span class="help_example"><code>[shortcode_load id="2" data="&lt;div class="myDiv"&gt;Content within a div called myDiv&lt;/div&gt;"]</code></span></li>';
        $html .= '</ul>'; // ./shortcode_load_parameters_data
        $html .= '</li>';
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><p class="help_example_text"><strong>Example:</strong></p><span class="help_example"><code>[shortcode_load id="2" data="var myVariable=\'Check mate, mate!\',mySecondVariable=true;myFunction(myVariable, mySecondVariable);" data_wrap="script"]</code></span></li>';
