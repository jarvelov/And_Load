...
Class ShortcodeLoad_Options extends ShortcodeLoad {
    ...
    **/
    ...
    function shortcode_load_help_documentation_callback() {
        ...
        $html .= '<li>This parameter is useful when you need to output extra data from your page, such as javascript variables, dynamic content generated by another plugin or data output from another shortcode. Depending on how other plugins output data from their shortcode it might not work as expected. The content will be dumped to the page before the file is loaded.';
        $html .= '<li><span class="help_example"><strong>Example:</strong> [shortcode_load id="2" data="\<div\>Content within a div\</div\>"]</span></li>';
        ...
        $html .= '<li>This parameter is useful when you need to output extra data from your page, such as javascript variables, dynamic content generated by another plugin or data output from another shortcode. Depending on how other plugins output data from their shortcode it might not work as expected. The content will be dumped to the page before the file is loaded.';
        $html .= '<li><span class="help_example"><strong>Example:</strong> [shortcode_load id="2" data="var myVariable=\'14\',mySecondVariable=\'true\';myFunction(myVariable, mySecondVariable);" data_wrap]</span></li>';
