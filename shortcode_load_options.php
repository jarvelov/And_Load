...
Class ShortcodeLoad_Options extends ShortcodeLoad {
    ...
    **/
    ...
    function shortcode_load_help_documentation_callback() {
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><span class="help_example"><strong>Example:</strong> <code>[shortcode_load id="2"]</code></span></li>';
        ...
        $html .= '</ul>';
        $html .= '</li>';        
        $html .= '<li><span class="help_example"><strong>Example:</strong> <code>[shortcode_load id="2" revision_override="14"]</code></span>';
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><span class="help_example"><strong>Example:</strong> <code>[shortcode_load id="2" minify_override="true"]</code></span>';
        ...
        $html .= '<li><span class="help_example"><strong>Example:</strong> <code>[shortcode_load id="2" data="&lt;div class="myDiv"&gt;Content within a div called myDiv&lt;/div&gt;"]</code></span></li>';
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><span class="help_example"><strong>Example:</strong> <code>[shortcode_load id="2" data="var myVariable=\'Check mate, mate!\',mySecondVariable=true;myFunction(myVariable, mySecondVariable);" data_wrap="script"]</code></span></li>';
