...
Class ShortcodeLoad_Options extends ShortcodeLoad {
    ...
    **/
    ...
    function shortcode_load_help_documentation_callback() {
        ...
        $html .= '</ul>';
        $html .= '</li>';
        $html .= '<li><span class="help_example"><strong>Example:</strong> <code>[shortcode_load id="2" data="var myVariable=\'14\',mySecondVariable=\'true\';myFunction(myVariable, mySecondVariable);" data_wrap="script"]</code></span></li>';
