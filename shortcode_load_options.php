...
Class ShortcodeLoad_Options {
	...
	function shortcode_load_default_automatically_minify_callback() {
		...
		$html = '<input type="checkbox" id="default_minify_checkbox" name="shortcode_load_default_options[default_minify_checkbox]" value="1"' . checked( 1, $options['default_minify_checkbox'], true ) . '/>';
