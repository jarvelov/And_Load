...
Class ShortcodeLoad_Options extends ShortcodeLoad {
    ...
    **/
    ...
    function shortcode_load_help_documentation_callback() {
        ...
        $html .= '<li><span class="help_example"><strong>Example:</strong> [shortcode_load id="2" raw_data="<![CDATA[<script>var myVariable=\'14\',mySecondVariable=\'true\',myThirdVariable=\'somevalue123\'</script>]]>"]</span></li>';
